 ...
 * @author Arek
 */
@WebServlet("/SummaryView")
public class summaryViewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<th>Ilosc wydarzen<th>");
        out.println("</tr>");
        ...
        for (int i = 0; i < model.getDays().size(); i++) {
            ...
            out.println("<tr>");
            out.println("<td>");
            out.println(day.getDate());
            out.println("<td>");
            out.println("<td>");
            out.println(day.getEvents().size());
            out.println("<td>");     
        }
